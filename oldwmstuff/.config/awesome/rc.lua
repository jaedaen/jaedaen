...
terminal = "roxterm --colour-scheme Default"
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ 1,2,3 }, s, layouts[2])
--    tags[s] = awful.tag({ 2 }, s, layouts[9])
 --   tags[s] = awful.tag({ 3 }, s, layouts[1])
end
-- }}}
...
diskwidget.image = image("/home/justin/.config/awesome/du.png")
...
-- Use --title to name a client and then specify properties for it in awful.rules below:

awful.util.spawn_with_shell("run_limited soupwhale 1 && roxterm --title soupwhale --colour-scheme lightblue -e term_exec ssh slappy@soupwhale.com","1")
awful.util.spawn_with_shell("run_limited soupwhale-irc 1 && roxterm --title soupwhale-irc --colour-scheme lightblue -e term_exec ssh slappy@soupwhale.com","1")
awful.util.spawn_with_shell("run_limited router 1 && roxterm --title router --colour-scheme red -e term_exec ssh -p60 root@router","1")
awful.util.spawn_with_shell("run_limited local_shell 1 && roxterm --title local_shell --colour-scheme Default -e /bin/bash","1")
awful.util.spawn_with_shell("run_limited firefox 1 && firefox","1")
...
awful.rules.rules = {
    ...
    { rule = { name = "soupwhale" }, --use name rules with the spawn_with_shells above
      properties = { tag = tags[1][2] } },
    { rule = { name = "soupwhale-irc" },
      properties = { tag = tags[1][2] } },
    { rule = { class = "pinentry" },
      properties = { floating = true } },
    { rule = { class = "gimp" },
      properties = { ftag = tags[1][3], floating = true } },
